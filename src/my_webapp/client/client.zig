...
pub const Client = struct {
    ...
    pub fn init(allocator: Allocator, config: Config) !Client {
        ...
        if (native_os == .windows) {
           //try stream.setsockopt(posix.SO.RCVTIMEO, &val);
           //try stream.setsockopt(posix.SO.SNDTIMEO, &val);
           const windows = std.os.windows; 
           //var buf: [256]u8 = undefined;
           //var buflen: i32 = 0;
           //const errcode = windows.ws2_32.getsockopt(stream.stream.handle, posix.SOL.SOCKET, posix.SO.RCVTIMEO, &buf, &buflen);
           //logging.log("err: {}, len: {} data: {} {} {} {} {} {} {} {}\n", .{errcode, buflen, buf[0],buf[1],buf[2],buf[3], buf[4],buf[5],buf[6],buf[7]}) catch unreachable;
           //logging.log("err: {}\n", .{windows.ws2_32.WSAGetLastError()}) catch unreachable;
           var mode: c_ulong= 1;
            const errcode2 = windows.ws2_32.ioctlsocket(stream.stream.handle, windows.ws2_32.FIONBIO, &mode);
            logging.log("err: {}\n", .{errcode2}) catch unreachable;
        }
...
pub const Stream = struct {
    ...
    pub fn writeAll(self: *Stream, data: []const u8) !void {
        ...
        try logging.log("stream.writeAll\n",.{});
